...
class LifetimeSize extends PSModule {
  ...
  constructor(
    ...
    if ( descriptor?.size === undefined || isPSValue3DDescriptor(descriptor?.size)) {
      ...
      this.size = new PSValue3D(tmpDescriptor, undefined, onChange);
    }
  }
